...
for ($i = 0; $i < $largo; $i++) {
    ...
    if ($cast < 80000000) {
        $myServiceFunction[$i][9] = "<td><FONT COLOR=#00C9A7>".$myServiceFunction[$i][6]."</FONT></td></tr>";
        ...
        $myServiceFunction[$i][9] = "<td><FONT COLOR=#EC9A3C>".$myServiceFunction[$i][6]."</FONT></td></tr>";
        array_push($myServiceFunction[$i], "<td><span class='legend-indicator bg-warning'></span>MEDIO</td></tr>");
    } elseif ($cast > 200000000) {
        $myServiceFunction[$i][9] = "<td><FONT COLOR=#ED4C78>".$myServiceFunction[$i][6]."</FONT></td></tr>";
